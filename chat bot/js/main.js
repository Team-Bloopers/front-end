...
let intro = ["Hello, I am Roco", "Hi, I am a Robo", "Hello, My name is Roco"];
...
function chatbotvoice(message){
    ...
    speech.text = "Please contact to any of the event coordinators between 10 am to 6pm on any working day. Thanks.";
